...
- navigate to the conference page: https://www.basta.net/frankfurt
...
- create a prompt for gemini instructing it to create an image with the style of the theme from the previous showing the following scenario:
  "Two male speaker with a "do epic shit" t-shirt in purble and Easter bunny ears and sun glasses standing in front of an audience giving a presentation about the playwright tooling at a tech conference in Frankfurt/Main Germany. Easter decorations are visible in the room and spread over the image as well as a big banner with the text "Basta Spring 2026" in the background. Outside it's warm spring weather. The image should have a street art style and be colorful and eye-catching."
