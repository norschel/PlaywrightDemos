...
Erstelle einen MSTest-basierten Playwright-Test in C# (Playwright for .NET), der auf der Webseite https://www.md-devdays.de/ eine *Session* (kein Workshop) findet, die sich mit "Playwright" beschäftigt. Prüfe anschließend:

- Ob zu dieser Session ein Abstract vorhanden ist.
- Ob **Harald** und **Nico** als Vortragende gelistet sind.

Der Prompt soll klar, vollständig und wiederverwendbar sein. Bitte beachte die folgenden Anforderungen und Ausgabevorgaben.
...
- Vorgeschlagener Klassenname: `MdDevDaysPlaywrightSessionTest`.
- Vorgeschlagener Dateiname: `MdDevDaysPlaywrightSessionTest.cs`.
- Testinhalt:
	- Öffne die Startseite `https://www.md-devdays.de/`.
	...
	- Prüfe, dass sowohl "Harald" als auch "Nico" in den Speaker-Angaben auftauchen.
...
Vielen Dank — bitte liefere die komplette, lauffähige Testklasse als Antwort.